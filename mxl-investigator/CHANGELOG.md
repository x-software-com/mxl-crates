...
## [0.2.7](https://github.com/x-software-com/mxl-crates/compare/mxl-investigator-v0.2.6...mxl-investigator-v0.2.7) - 2025-11-26
...
- [**breaking**] change behavior when a directory is deleted or retained
- *(deps)* update sysinfo requirement from 0.35 to 0.36
